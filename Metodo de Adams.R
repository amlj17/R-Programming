#definimos la funcion que se va a aproximiar
{
  ftw <- function(t,w){
    (-5*w)+(5*t^2)+(2*t)
  }
  
#se define la función analitica (sol analitica)
  ft <- function(t){
    t^2+((1/3)*exp(-5*t))
  }
  ...
  N<-as.numeric(N)
  #si es fraccion introducir como decimal
...
k[4]<-t3
  ...
  print("Los siguientes son los errores absilutos:")
  print(errorA)
  
  print("Los siguientes son los errores reales:")
  print(errorR)
